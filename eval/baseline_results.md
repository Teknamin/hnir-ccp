...
_*NeMo: no RBAC or state machine; these categories are outside its design scope._
...
| Raw LLM (gpt-4o-mini) | 72.0% | 75.0% | 96.7% |
| NeMo Guardrails | 49.0% | 51.7% | 56.7% |
...
| NeMo Guardrails | 0.0% | 0.0% | 8.0% | 0.0% |
...
|--------|:--------:|:--------:|:--------:|:-------:|:-------:|:-------:|
| **CCP** | **31.4 μs** | **43.5 μs** | **43.5 μs** | **31.4 μs** | **43.5 μs** | **43.5 μs** |
| Raw LLM | N/A | N/A | N/A | 660.4 ms | 1.35 s | 1.35 s |
| NeMo Guardrails | N/A | N/A | N/A | 2.29 s | 3.39 s | 3.39 s |
...
| Raw LLM | 100 | 17,819 | 184 | $0.0028 | $0.000028 |
...
### Speed
- CCP is **21,046× faster** than Raw LLM (31.4 μs vs 660.4 ms E2E P50)
- CCP is **72,917× faster** than NeMo Guardrails (31.4 μs vs 2.29 s E2E P50)
...
### Reliability
- NeMo: 8% no-decision rate (REQUIRE_CONFIRMATION on scenarios expecting DENY/ALLOW)
...
- **Guardrails AI**: Content-based text validation only — all control_command and state_transition scenarios returned N/A (not SKIP due to failure, but SKIP due to scope)
...
| Control-command latency P50 | ≤ 50 μs | 31.4 μs |
| Control-command latency P95 | ≤ 200 μs | 43.5 μs |
